...
//            console.log($(this).val());
                        ...
                        function mostrarCampoInvisivel(check) {
                            if ($(check).is(':checked')) {
                                ...
                                var lblAreas = document.createElement("label");
                                var lblLattes = document.createElement("label");
                                var txtLattes = document.createElement("input");

                                $(lblAreas).html("Áreas");
                                $(lblAreas).attr("class", "etiqueta");

                                $(lblLattes).html("Curriculum Lattes");
                                $(lblLattes).attr("for", "txtLattes");
                                $(lblLattes).attr("class", "etiqueta");

                                $(txtLattes).attr("type", "url");
                                $(txtLattes).attr("class", "campoDeEntrada");
                                $(txtLattes).attr("name", "pLattes");
                                $(txtLattes).attr("id", "txtLattes");
                                $(txtLattes).prop('required', true);
                                ...
                                $(legend).html("Avaliador");

                                $(fieldset).attr("id", 'areaAtuacao');
                                fieldset.appendChild(legend);
                                fieldset.appendChild(lblLattes);
                                fieldset.appendChild(txtLattes);
                                fieldset.appendChild(lblAreas);
